...
from sonilo._requests import build_v2v_sfx_parts
...
from sonilo.types import SfxSegment, SfxTask, VideoResult

if TYPE_CHECKING:
    from sonilo._async_client import AsyncSonilo
    from sonilo._client import Sonilo

PATH = "/v1/video-to-video-sfx"


class VideoToVideoSfx:
    ...
    def submit(
        ...
        *,
        ...
        data, files, opened = build_v2v_sfx_parts(video, video_url, prompt, segments)
